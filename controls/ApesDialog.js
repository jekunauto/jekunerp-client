...
var ApesDialog =  sap.ui.commons.Dialog.extend("apestech.ui.erp.controls.ApesDialog", { 
    metadata : {     
    ...
    _minimize_order:0,
  	...
  	renderer : function(rm, oControl){
		...
		if(oControl.getHeight() === "100%" && oControl.getWidth() === "100%") {
			oControl._maximize = true;
		}
...
ApesDialog.prototype.onclick = function (oEvent) {
...
ApesDialog.prototype.reOpen = function(){
	if(this._minimize) this.executePreviousSize();
};

ApesDialog.prototype.isMinimize = function(){
	return this._minimize;
};

ApesDialog.prototype.isMaximize = function(){
	return this._maximize;
};

ApesDialog.prototype.executeMinimize = function(){
...
ApesDialog.prototype.executeMaximize = function(){
	var elem = document.getElementById(this.getId()).getBoundingClientRect();
...
ApesDialog.prototype.executePreviousSize = function(){
	var elem = document.getElementById(this.getId()).getBoundingClientRect();
...
ApesDialog.prototype._reorderMinimizeDialog = function(){
...
ApesDialog.prototype._resizeMinimizeDialog = function(){
	var w = document.documentElement.clientWidth || document.body.clientWidth;
	var col = parseInt((w-1)/this.getMinimizeWidth(),10);
