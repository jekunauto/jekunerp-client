...
sap.ui.define([
	...
	var ApesSelectDialog = Control.extend("apestech.ui.erp.controls.ApesSelectDialog", /** @lends sap.m.ApesSelectDialog.prototype */ { metadata : {
	 ...
	 * @private
	 */
	ApesSelectDialog.prototype.init = function () {
		var that = this,
			iLiveChangeTimer = 0,
		...
		this._oTable = new Table(this.getId() + "-table", {
			...
			infoToolbar: new Toolbar({
				...
				content: [
					new Label({
						text: this._oRb.getText("ApesSelectDialog_SELECTEDITEMS", [0])
					})
				]
			}),
	 ...
	 * @private
	 */
	ApesSelectDialog.prototype.exit = function () {
		// internal variables
		this._oTable = null;
	...
	* @overwrite
	* @protected
	* @returns {sap.m.ApesSelectDialog} this pointer for chaining
	*/
	ApesSelectDialog.prototype.onAfterRendering = function () {
	...
	* @returns {sap.m.ApesSelectDialog} this pointer for chaining
	*/
	ApesSelectDialog.prototype.invalidate = function () {
	 ...
	 * @returns {sap.m.ApesSelectDialog} <code>this</code> to allow method chaining
	 * @ui5-metamodel This method also will be described in the UI5 (legacy) designtime metamodel
	 */
	ApesSelectDialog.prototype.open = function (sSearchValue) {
	...
	*/
	 ...
	 * @returns {sap.m.ApesSelectDialog} this pointer for chaining
	 */
	ApesSelectDialog.prototype.setBusy = function (bBusy) {
	 ...
	 */
	ApesSelectDialog.prototype.getBusy = function () {
	 ...
	 * @returns {sap.m.ApesSelectDialog} this pointer for chaining
	 */
	ApesSelectDialog.prototype.setBusyIndicatorDelay = function (iValue) {
	 ...
	 * @returns {sap.m.ApesSelectDialog} this pointer for chaining
	 */
	ApesSelectDialog.prototype.setMultiSelect = function (bMulti) {
	 ...
	 * @returns {sap.m.ApesSelectDialog} this pointer for chaining
	 */
	ApesSelectDialog.prototype.setTitle = function (sTitle) {
	 ...
	 */
	ApesSelectDialog.prototype.setNoDataText = function (sNoDataText) {
	 ...
	 */
	ApesSelectDialog.prototype.getNoDataText = function () {
	 ...
	 */
	ApesSelectDialog.prototype.getContentWidth = function () {
	 ...
	 * @returns {sap.m.ApesSelectDialog} this pointer for chaining
	 */
	ApesSelectDialog.prototype.setContentWidth = function (sWidth) {
	 ...
	 */
	ApesSelectDialog.prototype.getContentHeight = function () {
	 ...
	 * @returns {sap.m.ApesSelectDialog} this pointer for chaining
	 */
	ApesSelectDialog.prototype.setContentHeight = function (sHeight) {
	 ...
	 * @returns {sap.m.ApesSelectDialog} this pointer for chaining
	 */
	ApesSelectDialog.prototype.addStyleClass = function () {
	 ...
	 * @returns {sap.m.ApesSelectDialog} this pointer for chaining
	 */
	ApesSelectDialog.prototype.removeStyleClass = function () {
	 ...
	 * @returns {sap.m.ApesSelectDialog} this pointer for chaining
	 */
	ApesSelectDialog.prototype.toggleStyleClass = function () {
	 ...
	 */
	ApesSelectDialog.prototype.hasStyleClass = function () {
	 ...
	 */
	ApesSelectDialog.prototype.getDomRef = function () {
		if (this._oDialog) {
	 ...
	 * @returns {sap.m.ApesSelectDialog} This pointer for chaining
	 */
	ApesSelectDialog.prototype._setModel = ApesSelectDialog.prototype.setModel;
	ApesSelectDialog.prototype.setModel = function (oModel, sModelName) {
		...
		ApesSelectDialog.prototype._setModel.apply(this, aArgs);
	 ...
	 * @returns {sap.m.ApesSelectDialog} this pointer for chaining
	 */
	ApesSelectDialog.prototype.bindAggregation = function () {
	...
	ApesSelectDialog.prototype.validateAggregation = function (sAggregationName, oObject, bMultiple) {
		return this._callMethodInManagedObject("validateAggregation", sAggregationName, oObject, bMultiple);
	};

	ApesSelectDialog.prototype.setAggregation = function (sAggregationName, oObject, bSuppressInvalidate) {
		this._callMethodInManagedObject("setAggregation", sAggregationName, oObject, bSuppressInvalidate);
		return this;
	};

	ApesSelectDialog.prototype.getAggregation = function (sAggregationName, oDefaultForCreation) {
		return this._callMethodInManagedObject("getAggregation", sAggregationName, oDefaultForCreation);
	};

	ApesSelectDialog.prototype.indexOfAggregation = function (sAggregationName, oObject) {
		return this._callMethodInManagedObject("indexOfAggregation", sAggregationName, oObject);
	};

	ApesSelectDialog.prototype.insertAggregation = function (sAggregationName, oObject, iIndex, bSuppressInvalidate) {
		this._callMethodInManagedObject("insertAggregation", sAggregationName, oObject, iIndex, bSuppressInvalidate);
		return this;
	};

	ApesSelectDialog.prototype.addAggregation = function (sAggregationName, oObject, bSuppressInvalidate) {
		this._callMethodInManagedObject("addAggregation", sAggregationName, oObject, bSuppressInvalidate);
		return this;
	};

	ApesSelectDialog.prototype.removeAggregation = function (sAggregationName, oObject, bSuppressInvalidate) {
		this._callMethodInManagedObject("removeAggregation", sAggregationName, oObject, bSuppressInvalidate);
		return this;
	};

	ApesSelectDialog.prototype.removeAllAggregation = function (sAggregationName, bSuppressInvalidate) {
		return this._callMethodInManagedObject("removeAllAggregation", sAggregationName, bSuppressInvalidate);
	};

	ApesSelectDialog.prototype.destroyAggregation = function (sAggregationName, bSuppressInvalidate) {
		this._callMethodInManagedObject("destroyAggregation", sAggregationName, bSuppressInvalidate);
		return this;
	};

	ApesSelectDialog.prototype.getBinding = function (sAggregationName) {
		return this._callMethodInManagedObject("getBinding", sAggregationName);
	};

	ApesSelectDialog.prototype.getBindingInfo = function (sAggregationName) {
		return this._callMethodInManagedObject("getBindingInfo", sAggregationName);
	};

	ApesSelectDialog.prototype.getBindingPath = function (sAggregationName) {
		return this._callMethodInManagedObject("getBindingPath", sAggregationName);
	};

	ApesSelectDialog.prototype.getBindingContext = function (sModelName) {
	 ...
	 * @returns {sap.m.ApesSelectDialog} this pointer for chaining
	 */
	ApesSelectDialog.prototype._setBindingContext = ApesSelectDialog.prototype.setBindingContext;
	ApesSelectDialog.prototype.setBindingContext = function (oContext, sModelName) {
		var args = Array.prototype.slice.call(arguments);
		...
		ApesSelectDialog.prototype._setBindingContext.apply(this, args);
	 ...
	 * @returns {sap.m.ApesSelectDialog} this pointer for chaining
	 */
	ApesSelectDialog.prototype._executeSearch = function (sValue, sEventType) {
	 ...
	 */
	ApesSelectDialog.prototype._setBusy = function (bBusy) {
	 ...
	 */
	ApesSelectDialog.prototype._updateStarted = function (oEvent) {
	 ...
	 * @param {jQuery.Event} oEvent The event object
	 */
	ApesSelectDialog.prototype._updateFinished = function (oEvent) {
		this._updateSelectionIndicator();
	 ...
	 */
	ApesSelectDialog.prototype._getOkButton = function () {
		var that = this,
			fnOKAfterClose = null;
	 ...
	 * @return {sap.m.Button} The button
	 */
	ApesSelectDialog.prototype._getCancelButton = function () {
		var that = this;
	 ...
	 * @private
	 */
	ApesSelectDialog.prototype._onCancel = function (oEvent) {
		var that = this,
			fnAfterClose = null;
	 ...
	 * @private
	 */
	ApesSelectDialog.prototype._updateSelectionIndicator = function () {
		...
		oInfoBar.getContent()[0].setText(this._oRb.getText("ApesSelectDialog_SELECTEDITEMS", [iSelectedContexts]));
	};
	 ...
	 * @private
	 */
	ApesSelectDialog.prototype._fireConfirmAndUpdateSelection = function () {
	 ...
	 * @private
	 */
	ApesSelectDialog.prototype._updateSelection = function () {
	 ...
	 * @private
	 */
	ApesSelectDialog.prototype._resetSelection = function () {
		var i = 0;
