...
sap.ui.define([
		...
		return BaseController.extend("jekunauto.ui.erp.controller.ApiDetail", {
			...
			_createMethodsSummary: function () {
				var oSummaryTable = sap.ui.xmlfragment(this.getView().getId() + "-methodsSummary", "jekunauto.ui.erp.view.ApiDetailMethodsSummary", this);
			...
			_createEventsSummary: function () {
				var oSummaryTable = sap.ui.xmlfragment(this.getView().getId() + "-eventsSummary", "jekunauto.ui.erp.view.ApiDetailEventsSummary", this);
			...
			_createAnnotationsSummary: function () {
				var oSummaryTable = sap.ui.xmlfragment(this.getView().getId() + "-annotationsSummary", "jekunauto.ui.erp.view.ApiDetailAnnotationsSummary", this);
